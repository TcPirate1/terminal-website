...
- [ ] Add `robots.txt` (don't forget to add sitemap url) and `sitemap.(txt,xml,rss)`. Sitemap will most likely be txt. Pin for later, writing a generator can be another project.
